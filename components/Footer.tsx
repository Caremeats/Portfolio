  ...
  return (
    <footer className="w-full pb-10 mb-[5px] md:mb-5" id="contact">
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-white-200 md:mt-10 my-5 text-center"> Reach Out to me today and we can discuss how we can achieve your goals.</p>
      ...
      <div className="flex flex-col md:flex-row mt-16 justify-between items-center">
        <p className="md:text-base text-sm md:font-normal font-light">Copyright © 2024 Erryl</p>
